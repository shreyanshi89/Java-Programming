...
# Types of operators in Java
	...
	- Bitwise Operator :             {& ^ |} [bitwise AND, exclusive OR]
	- Logical Operator :			 {&& ||}
...
class OperatorsInJava {
	...
	void UnaryOperator() {
		 ...
		 * with all the bits inverted, which means every 0 to 1, and every 1 to 0.
		 * */
	...
	void RelationalOperator() {
		...
		System.out.println("Inside RealationalOperator");
